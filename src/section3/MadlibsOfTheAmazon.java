...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		// night. Piranhas are attracted to fresh [type of liquid] Piranhas are attracted to fresh[body part] if you [verb]. Whatever
		// you do, if you have an open wound, try to find another way to get
		// back to the [place]. Good luck!
		
		// Make a pop-up for the final story. You can use \n to go to the next line
		JOptionPane.showMessageDialog(null, "Piranhas are more " + adjective + " during the day, so cross the river at night.\n Piranhas are attracted to fresh " + liquid + " and will most likely take a bite of your " + bodyPart + " if you" + verb + ". \n Whatever you do, if you have an open wound, try and find another way to get back to the " + place + ".\n Good luck!");
